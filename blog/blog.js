...
(function () {
    ...
    if (!document.querySelector("[data-tag-cloud]")) {
      ...
      grid.insertAdjacentHTML(
        ...
        '<div class="tag-cloud-slot" data-tag-cloud><div class="tag-cloud-panel">' +
          '<p class="tag-cloud-label">Темы</p><div class="tag-cloud">' + pills + "</div></div></div>" +
  ...
  function initArticleEngagement() {
    ...
    var shareLinks = [
      ...
      { id: "vk", label: "VK", href: "https://vk.com/share.php?url=" + encUrl + "&title=" + encTitle, icon: "vk" },
